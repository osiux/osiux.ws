...
const baseInput = css`
	${tw`w-full p-2 border border-gray-800 border-solid transition-colors duration-500 md:w-3/4 dark:(text-gray-900 bg-gray-300)`}
`;
...
const Button = styled.button`
	${tw`transition-colors duration-500 border border-solid border-gray-800 bg-gray-900 text-gray-100 outline-none py-3 px-5 w-full self-end md:w-auto md:py-3 md:px-10 dark:(border-gray-100 bg-gray-600)`}
